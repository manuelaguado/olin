            ...
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset mt-login-5-bsfix">
                    <div class="login-bg" style="background-image:url(<?=URL_PUBLIC?>assets/pages/img/login/bg1.jpg)">
                        <img class="login-logo" height="30px" src="<?=URL_PUBLIC?>assets/images/framedev.png" /> </div>
                </div>
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                        <img height="40px" src="<?=URL_PUBLIC?>assets/images/framedev.png">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-right">
                                    <div class="forgot-password">
										<a href="javascript:;" id="register-form" class="forget-password">Registrarse</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
